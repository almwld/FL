...
class SkinCareScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> _categories = const [
    ...
    {'name': 'ماسكات', 'icon': Icons.face, 'color': Colors.green, 'count': '87'},
    {'name': 'سيروم', 'icon': Icons.opacity, 'color': Colors.purple, 'count': '76'},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'العناية بالبشرة'),
